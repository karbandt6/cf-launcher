...
if command -v cloudflared >/dev/null 2>&1; then
    ...
    # Menggunakan sudo untuk menghindari error permission saat install
...
# start cloudflared 100% silent (semua log diarahkan ke file)
cloudflared tunnel \
--no-autoupdate \
...
# TRAP: Pastikan tunnel mati dan file log dihapus jika user menekan Ctrl+C
trap 'echo -e "\n${C_RED}🛑 Shutting down tunnel...${C_DEF}"; kill $CF_PID 2>/dev/null || true; rm -f "$TMPLOG"; exit 0' SIGINT SIGTERM EXIT
...
if [ -z "$URL" ]; then
    ...
    # Trap akan otomatis mematikan proses
    exit 1
fi
...
echo -e "${C_GRAY}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${C_DEF}"
echo -e "${C_YELLOW}Tekan Ctrl+C untuk menghentikan tunnel.${C_DEF}"
